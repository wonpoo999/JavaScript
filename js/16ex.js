// 오늘 시간표 - time, todo 배열 선언
    ...
    function timeline(timeArr, todoArr, dayLabel){ //입력: 시간표 배열, 할일 배열, 제목
                                                                // 형식 매개변수 (값은 실행할 때 전달되어 저장.)
    timeTr.innerHTML = '<th>TIME</th>'
      todoTr.innerHTML = '<th>TODO</th>'
       favicon.href = dayLabel === '오늘' ? '../images/today.webp' : '../images/tomorrow.webp';

      title.textContent = `${dayLabel} 시간표`;
    ...
    //   const currentTime = isToday ? time2 : time;
    //   const currentTodo = isToday ? todo2 : todo;
